...
{
    public partial class retrofill_reprint : Form
    {
        ...
        private void update_retrofill_fuzed()
        {
            ...
            label.Variables["ValP"].SetValue(txt_val_c.Text);
        ...
        private void txt_val_a_Leave(object sender, EventArgs e)
        {
            update_retrofill_fuzed();
        }
        ...
        {
            var retrofill_side_reprint = new retrofill_side_reprint();
            Hide();
            retrofill_side_reprint.Show();
        }
